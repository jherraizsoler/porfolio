...
const projectsData = {
    ...
    `,
    images: ['Media/proyectos/Proyecto1/imagenPrincipal.jpeg', 'Media/proyectos/Proyecto1/ventanaPrincipal_1.jpeg'],
    skills: ['JavaFX', 'Spring Framework', 'MySQL', 'Programación', 'Maven', 'JPA', 'Spring Boot', 'Lombok', 'Gestión de proyectos', 'Metodologías ágiles', 'Capacidad de análisis e investigación'],
    links: {
        github: 'https://github.com/jherraizsoler/tareas_JavaFX-SpringBoot',
        linkedin: 'https://www.linkedin.com/posts/jorge-herraiz-soler-25679725b_nuevoproyecto-activity-7363223176245370881-Sg4H?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEACjaIB6DsKY_IcuDUqisiL9oD5WELnCHk'
    }
    },
    '2': {
    ...
    `,
    images: ['Media/proyectos/Proyecto2/imagenPrincipal.jpeg',
    ...
    skills: ['Jakarta EE', 'MySQL', 'GlassFish', 'Jakarta JWS', 'PrimeFaces', 'Maven', 'EJB', 'SLF4J', 'JPA', 'EclipseLink', 'Java', 'Gestión y documentación de proyectos', 'HTML5', 'Metodologías ágiles', 'Apache Netbeans IDE'],
    links: {
        github: 'https://github.com/jherraizsoler/personas-ejb-jee-web',
        linkedin: 'https://www.linkedin.com/posts/jorge-herraiz-soler-25679725b_nuevoproyecto-activity-7364310370116583424-1ZNv?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEACjaIB6DsKY_IcuDUqisiL9oD5WELnCHk'
    }
    },
    '3': {
    ...
    `,
    images: ['Media/proyectos/Proyecto3/imagenPrincipal.jpeg',
    ...
    skills: ['Spring Framework', 'MySQL', 'Thymeleaf', 'Programación', 'Maven', 'JPA', 'Administración de sistemas y servidores', 'CSS Responsive', 'SASS', 'Flexbox', 'Grid', 'Bootstrap', 'Spring Boot', 'Analítico y algorítmico', 'Gestión y documentación de proyectos', 'Metodologías ágiles', 'Planificación de proyectos', 'Lombok', 'Capacidad de análisis e investigación'],
    links: {
        github: 'https://github.com/jherraizsoler/contactos_Thymeleaf-SpringBoot',
        linkedin: 'https://www.linkedin.com/posts/jorge-herraiz-soler-25679725b_nuevoproyecto-activity-7363947996163510272-Z__I?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEACjaIB6DsKY_IcuDUqisiL9oD5WELnCHk'
    }
    },
    '4': {
    ...
    `,
    images: ['Media/proyectos/Proyecto4/imagenPrincipal.jpeg',
    ...
    skills: ['JSTL', 'Tomcat', 'Spring Framework', 'Hibernate', 'MySQL', 'Programación', 'Maven', 'JPA', 'Spring Boot', 'Gestión y documentación de proyectos', 'JSP', 'Metodologías ágiles', 'Planificación de proyectos', 'Lombok'],
    links: {
        github: 'https://github.com/jherraizsoler/empleados_JavaJSP-SpringBoot',
        linkedin: 'https://www.linkedin.com/posts/jorge-herraiz-soler-25679725b_nuevoproyecto-activity-7364234844140109825-Z7zG?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEACjaIB6DsKY_IcuDUqisiL9oD5WELnCHk'
    }
    },
    '5': {
    ...
    `,
    images: ['Media/proyectos/Proyecto5/imagenPrincipal.jpeg',
    ...
    skills: ['Angular', 'Desarrollo front end', 'Programación', 'Administración de sistemas y servidores', 'Microsoft Visual Studio Code', 'CSS Responsive', 'SASS', 'Flexbox', 'Grid', 'Bootstrap', 'Analítico y algorítmico', 'Gestión y documentación de proyectos', 'HTML5', 'Metodologías ágiles', 'Angular CLI', 'TypeScript', 'Planificación de proyectos', 'Capacidad de análisis e investigación'],
    links: {
        github: 'https://github.com/jherraizsoler/appPresupuesto_angular',
        linkedin: 'https://www.linkedin.com/posts/jorge-herraiz-soler-25679725b_nuevoproyecto-activity-7363842300013142016-hAWD?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEACjaIB6DsKY_IcuDUqisiL9oD5WELnCHk'
    }
    },
    '6': {
    ...
    skills: ['Jakarta EE', 'MySQL', 'Programación', 'PrimeFaces', 'Maven', 'Enterprise JavaBeans', 'JPA', 'EclipseLink', 'Java', 'Gestión y documentación de proyectos', 'Metodologías ágiles', 'Planificación de proyectos', 'Apache Netbeans IDE'],
    links: {
    ...
    '7': {
    title: 'Proyecto FullStack GymFlow: Sistema Integral de Gestión de clientes para Gimnasios',
    content: `
        <h3>Descripción del Proyecto</h3>
    ...
    `,
    images: ['Media/proyectos/Proyecto7/imagenPrincipal.jpeg',
    ...
    skills: ['Spring Framework', 'Programación', 'Maven', 'Java Swing', 'Administración de sistemas y servidores', 'Analítico y algorítmico', 'Gestión y documentación de proyectos', 'Metodologías ágiles', 'Planificación de proyectos', 'Apache Netbeans IDE', 'Console', 'Capacidad de análisis e investigación'],
    links: {
        github: 'https://github.com/jherraizsoler/GymFlow_ZonaFitConsoleSwingWebSpringBoot',
        linkedin: 'https://www.linkedin.com/posts/jorge-herraiz-soler-25679725b_me-alegra-compartir-que-he-trabajado-en-este-activity-7363479906225209344-u4JU?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEACjaIB6DsKY_IcuDUqisiL9oD5WELnCHk'
    }
    },
    '8': {
    ...
    skills: ['Jakarta EE', 'Programación', 'GlassFish', 'Maven', 'JPA', 'Analítico y algorítmico', 'Gestión y documentación de proyectos', 'Metodologías ágiles', 'Planificación de proyectos', 'Lombok', 'Capacidad de análisis e investigación.', 'MySQL'],
    links: {
        github: 'https://github.com/jherraizsoler/personas-backend-java',
        linkedin: 'https://www.linkedin.com/posts/jorge-herraiz-soler-25679725b_nuevoproyecto-activity-7364672707344408576-6zC2?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEACjaIB6DsKY_IcuDUqisiL9oD5WELnCHk'
    }
    },
    '9': {
    ...
    `,
    images: [
            'Media/proyectos/Proyecto9/imagenPrincipal.jpeg'
    ], // Agrega las rutas a tus imágenes si las tienes
    skills: ['Spring Framework', 'MySQL', 'Programación', 'Maven', 'JPA', 'Java', 'Spring Boot', 'Gestión y documentación de proyectos', 'Metodologías ágiles', 'Planificación de proyectos', 'Lombok'],
    links: {
        github: 'https://github.com/jherraizsoler/inventarios_springboot_backend',
        linkedin: 'https://www.linkedin.com/posts/jorge-herraiz-soler-25679725b_nuevoproyecto-activity-7364567005435183106-GUO_?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEACjaIB6DsKY_IcuDUqisiL9oD5WELnCHk'
    }
    },
    '10': {
    ...
    `,
    images: [
            'Media/proyectos/Proyecto10/imagenPrincipal.jpeg'
    ], 
    skills: ['Spring Framework', 'MySQL', 'Java Database Connectivity (JDBC)', 'Programación', 'Maven', 'Administración de sistemas y servidores', 'Spring Boot', 'Analítico y algorítmico', 'Gestión y documentación de proyectos', 'Metodologías ágiles', 'Planificación de proyectos', 'Capacidad de análisis e investigación.'],
    links: {
        github: 'https://github.com/jherraizsoler/rh_springboot_backend',
        linkedin: 'https://www.linkedin.com/posts/jorge-herraiz-soler-25679725b_nuevoproyecto-activity-7363117473442729984-SFbf?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEACjaIB6DsKY_IcuDUqisiL9oD5WELnCHk'
    }
    },
    '11': {
    ...
    skills: ['Angular', 'Programación', 'Administración de sistemas y servidores', 'Microsoft Visual Studio Code', 'Analítico y algorítmico', 'Gestión y documentación de proyectos', 'Metodologías ágiles', 'Angular CLI', 'API de Postman', 'Planificación de proyectos', 'Capacidad de análisis e investigación.'],
    links: {
        github: 'https://github.com/jherraizsoler/personas-frontend-angular',
        linkedin: 'https://www.linkedin.com/posts/jorge-herraiz-soler-25679725b_me-alegra-compartir-que-he-trabajado-en-este-activity-7363585596990066688-W4p-?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEACjaIB6DsKY_IcuDUqisiL9oD5WELnCHk'
    }
    },
    '12': {
    ...
    skills: ['Angular', 'Programación', 'Microsoft Visual Studio Code', 'Gestión y documentación de proyectos', 'Metodologías ágiles', 'Angular CLI', 'TypeScript', 'Planificación de proyectos'],
    links: {
        github: 'https://github.com/jherraizsoler/inventario-app_angular_frontend',
        linkedin: 'https://www.linkedin.com/posts/jorge-herraiz-soler-25679725b_nuevoproyecto-activity-7364597242957074435-43O7?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEACjaIB6DsKY_IcuDUqisiL9oD5WELnCHk'
    }
    },
    '13': {
    ...
    skills: ['Programación', 'Administración de sistemas y servidores', 'React', 'Microsoft Visual Studio Code', 'Analítico y algorítmico', 'Gestión y documentación de proyectos', 'Metodologías ágiles', 'Planificación de proyectos', 'Capacidad de análisis e investigación.'],
    links: {
        github: 'https://github.com/jherraizsoler/rh_app_react_frontend',
        linkedin: 'https://www.linkedin.com/posts/jorge-herraiz-soler-25679725b_nuevoproyecto-activity-7363147659655757824-1Srn?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEACjaIB6DsKY_IcuDUqisiL9oD5WELnCHk'
    }
    },
    '14': {
    ...
    `,
    images: [
            'Media/proyectos/Proyecto14/imagenPrincipal.jpeg'     
    ],
    skills: ['C#', 'Diseño de experiencia de usuario (UX) y interfaz de usuario (UI)', 'Resolución de problemas', '.NET Framework', 'Desarrollo web back end', 'Desarrollo de software', 'Inglés', 'Programación', 'Maven', 'Liderazgo', 'Administración de sistemas y servidores', 'ASP.NET MVC', 'Analítico y algorítmico', 'Gestión y documentación de proyectos', 'Metodologías ágiles', 'Entity Framework (EF) Core', 'Planificación de proyectos', 'Diseño y administración de bases de datos', 'Capacidad de análisis e investigación.'],
    links: {
        github: 'https://github.com/jherraizsoler/RetailApp.Backend',
        linkedin: 'https://www.linkedin.com/posts/jorge-herraiz-soler-25679725b_me-alegra-compartir-que-estoy-trabajado-en-activity-7356720798738329600-0MyI?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEACjaIB6DsKY_IcuDUqisiL9oD5WELnCHk'
    }
    },
    '15': {
    ...
    skills: ['Programación', 'Maven', 'JSON', 'Android', 'JetPack Compose', 'biometric', 'Administración de sistemas y servidores', 'Analítico y algorítmico', 'Gestión y documentación de proyectos', 'Metodologías ágiles', 'Kotlin', 'Planificación de proyectos', 'Capacidad de análisis e investigación.'],
    links: {
        github: 'https://github.com/jherraizsoler/personalHubAPP',
        linkedin: 'https://www.linkedin.com/posts/jorge-herraiz-soler-25679725b_nuevoproyecto-activity-7360397052524003328-unj1?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEACjaIB6DsKY_IcuDUqisiL9oD5WELnCHk'
    }
}
...
modalContainer.addEventListener('click', (event) => {
    if (event.target.id === 'close-modal' || event.target.id === 'modal-container') {
